/* calculadoraestatistica.com.br — cookie consent banner + Google Consent Mode v2 (GDPR/LGPD)
 * Standalone, no dependencies. Stores choice in localStorage as 'ce-consent' = 'granted' | 'denied'.
 */
(function () {
  'use strict';
  var KEY = 'ce-consent';
  ...
  function init() {
    ...
    banner.addEventListener('click', function (e) {
      ...
      document.dispatchEvent(new CustomEvent('ce:consent', { detail: { value: action } }));
    });
  }
